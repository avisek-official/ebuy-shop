...
export const Electronics = () => {
  document.title = "Buy Electronics items online at eBuy";
  ...
  const electronicsItems = productItems.filter(
  ...
  return (
    ...
    >
      ...
      >
        <span>Total No. of items: {electronicsItems.length}</span>
      ...
      {electronicsItems.length === 0 && <SkeletonLoader />}
      {electronicsItems.length !== 0 && (
        <div
          id="product-container"
          className="w-full flex flex-col md:flex-wrap md:flex-row justify-between"
        >
