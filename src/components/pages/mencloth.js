...
export const MenCloth = () => {
  document.title = "Buy Men's clothes online at eBuy";
  ...
  const menClothingItems = productItems.filter(
  ...
  return (
    ...
    >
      ...
      >
        <span>Total No. of items: {menClothingItems.length}</span>
      ...
      {menClothingItems.length === 0 && <SkeletonLoader />}
